    ...
    <div class="row">
      ...
      <nav class="col-lg-6 col-sm-9 col-xs-12">
        <ul class="s-footer-menu">
          ...
          <li><a target="_blank" rel="archives" href="https://www.instagram.com/lebeche.cultura/">Instagram</a></li>
          <li><a target="_blank" rel="archives" href="www.facebook.com/groups/senayan.slims">Facebook</a></li>
          <li><a href="admin/index.php">Bibliotecario</a></li>
          <li><a href="index.php?p=help">Ayuda</a></li>
