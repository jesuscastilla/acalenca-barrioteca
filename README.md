...
Sobre esta base de datos se apoya la [PWA de préstamos](https://github.com/jesuscastilla/acalenca-barrioteca-app/blob/main/README.md) que usan las socias desde el móvil.
